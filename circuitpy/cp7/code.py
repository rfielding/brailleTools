...
#
# F1..F9 Fn+[1..9] (ie: lower a,b,c,d,e,f,g,h,i)
# F10,F11,F12,F13,F14,F15,F16 Fn+[0,lower-k,lowerl,lowerm,lowern,lowero,lowerp]
#
            ...
            if o == 64:
                ...
                if isFn: # Fn isn't a real key on a keyboard. But for Fn key combos
                    ...
                    if c == ord('9'):
                        theKeys = [Keycode.F9]    
                        print("F9")    
                    if c == ord('0'): #10 - lower j
                        theKeys = [Keycode.F10]    
                        print("F10")    
                    if o == 2+64: #11 - lower k
                        theKeys = [Keycode.F11]    
                        print("F11")    
                    if o == 2+4+64: #12 - lower l
                        theKeys = [Keycode.F12]    
                        print("F12")    
                    if o == 2+16+64: #13 - lower m
                        theKeys = [Keycode.F13]    
                        print("F13")    
                    if o == 2+16+32+64: #14 - lower n
                        theKeys = [Keycode.F14]    
                        print("F14")    
                    if o == 2+32+64: #15 - lower o
                        theKeys = [Keycode.F15]    
                        print("F15")    
                    if o == 2+4+16+64: #16 - lower p
                        theKeys = [Keycode.F16]    
                        print("F16")    
                else:
